...
export default function HomeownerCarousel() {
  ...
  const slides: Slide[] = [
    ...
    {
      id: 5,
      title: "A timeline is more useful than snapshots.",
      content: "A chronological record makes documented changes easier to recognize than disconnected visits. It does not determine insurance coverage or a claim outcome.",
      primaryCta: "GOT IT",
      secondaryCta: "EXIT",
    },
    {
      id: 6,
      title: "ROOF PASSPORT — a continuing record.",
      content: "Your Roof Passport connects photographs, authorizations, maintenance, documents, and future updates in one secure property history.",
